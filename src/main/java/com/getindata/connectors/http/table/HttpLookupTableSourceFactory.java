...
import static com.getindata.connectors.http.table.HttpLookupConnectorOptions.ASYNC_POLLING;
import static com.getindata.connectors.http.table.HttpLookupConnectorOptions.FIELD;
import static com.getindata.connectors.http.table.HttpLookupConnectorOptions.FIELD_ALIAS;
import static com.getindata.connectors.http.table.HttpLookupConnectorOptions.PATH;
import static com.getindata.connectors.http.table.HttpLookupConnectorOptions.ROOT_NODE;
import static com.getindata.connectors.http.table.HttpLookupConnectorOptions.URL;
import static com.getindata.connectors.http.table.HttpLookupConnectorOptions.URL_ARGS;
...
public class HttpLookupTableSourceFactory implements DynamicTableSourceFactory {
  ...
  private void validateOptions(
    ...
    Set<ConfigOption<?>> optionalAliasPaths =
        getAliasConfigs(getFieldNames(physicalRowDataType), readableConfig);
  ...
  private DataType toRowDataType(List<Column> columns, Predicate<Column> columnPredicate) {
    return columns.stream()
        ...
        .collect(
            Collectors.collectingAndThen(Collectors.toList(), HttpLookupTableSourceFactory::ROW))
