...
class URLEncodedUtils {
     ...
     */
    static List<String> parsePathSegments(
     ...
     * <p>
     * Uses the {@link #URLENCODER} set of characters, rather than the {@link #UNRESERVED} set; this
     * is for compatibilty with previous releases, URLEncoder.encode() and most browsers.
     *
