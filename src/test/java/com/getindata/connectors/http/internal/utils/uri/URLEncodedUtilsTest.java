...
class URLEncodedUtilsTest {
    ...
    public void testFormatSegments() {
        String segments =
            URLEncodedUtils.formatSegments(List.of("segmentOne", "segmentTwo", "segmentThree"),
                Constants.UTF_8);
    ...
    public void testFormatEmptySegments() {
        String segments =
            URLEncodedUtils.formatSegments(Collections.emptyList(), Constants.UTF_8);
    ...
    public void testFormatNullSegments() {
        ...
        String segments =
            URLEncodedUtils.formatSegments(segmentList, Constants.UTF_8);
    ...
    public void testNullParse() {
        List<NameValuePair> components =
            URLEncodedUtils.parse(null, Constants.UTF_8);
    ...
    public void testBlankParse() {
        List<NameValuePair> components =
            URLEncodedUtils.parse(" ", Constants.UTF_8);
    ...
    public void testParse() {
        List<NameValuePair> components =
            URLEncodedUtils.parse("Hello Me=val1", Constants.UTF_8);
