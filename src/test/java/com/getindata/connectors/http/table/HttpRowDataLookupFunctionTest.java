...
class HttpRowDataLookupFunctionTest {
  ...
  @Mock private PollingClientFactory<RowData> pollingClientFactory;

  @Mock private FunctionContext context;

  @Mock private Collector<RowData> collector;

  @Mock private PollingClient<RowData> client;

  @Captor private ArgumentCaptor<List<LookupArg>> lookupArgCaptor;
  ...
  void setUp() throws Exception {
    ...
    HttpLookupConfig options = HttpLookupConfig.builder().columnNames(List.of("id, uuid")).build();
