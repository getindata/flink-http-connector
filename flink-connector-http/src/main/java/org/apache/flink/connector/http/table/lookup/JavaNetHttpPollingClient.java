...
import org.apache.flink.connector.http.retry.RetryConfigProvider;
...
/**
 * An implementation of {@link PollingClient} that uses Java 11's {@link HttpClient}. This
...
public class JavaNetHttpPollingClient implements PollingClient<RowData> {
     ...
     */
    protected HttpRequest updateHttpRequestIfRequired(
            HttpLookupSourceRequestEntry request, HeaderPreprocessor oidcHeaderPreProcessor) {
        ...
        if (oidcHeaderPreProcessor != null) {
            ...
            String bearerToken =
                    oidcHeaderPreProcessor.preprocessValueForHeader(
