...
public class AsyncHttpTableLookupFunction extends AsyncLookupFunction {
    ...
    /**
     * The {@link org.apache.flink.table.functions.TableFunction} we want to decorate with async
     * framework.
     */
                    ...
                    if (throwable != null) {
                        ...
                        resultFuture.completeExceptionally(
                                new RuntimeException(
                                        "Exception while processing Http Async request",
                                        throwable));
                    } else {
